...
const entry: EventEntry = {
  ...
  scores: { relevance: 6, influence: 76, cringe: 21, brainrot: 45 },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (40 returned) for “One Chip Challenge”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Character signals still mark this as strongly representative of chaotic internet brainrot culture. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikipedia page “One Chip Challenge” found but pageviews unavailable",
      ...
      "[news/recent-articles] Google News: 0 items in last 60d (40 returned) for “One Chip Challenge”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “One Chip Challenge”",
      "[bluesky/discussion-volume] Bluesky search unavailable for \"One Chip Challenge\"",
      "[youtube/recent-uploads] YOUTUBE_DATA_API_KEY not set — YouTube live search skipped",
      "[catalog-evidence/gen-cohort-adoption] Cohort cue from tags/title (brainrot character only)",
      "Weak corroboration — blended heuristic (0) with AI double-check (12): Recent news, Google Trends, and activity signals are all near zero, indicating the One Chip Challenge has very low current popularity despite lingering documentation.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (40 returned) for “One Chip Challenge”)",
