...
const entry: CreatorEntry = {
  ...
  scores: { relevance: 73, influence: 83, cringe: 60, brainrot: 55 },
  dynamicMetadata: {
    ...
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 11 items in last 60d (40 returned) for “Adin Ross”",
      ...
      "[bluesky/discussion-volume] Bluesky search unavailable for \"Adin Ross\"",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=57 (Google News: 11 items in last 60d (40 returned) for “Adin Ross”)",
