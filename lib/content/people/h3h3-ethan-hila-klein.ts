...
const entry: CreatorEntry = {
  ...
  scores: { relevance: 0, influence: 81, cringe: 40, brainrot: 32 },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (40 returned) for “h3h3 creator”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] No confident English Wikipedia match for “h3h3 creator”",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/authority-documentation] No Wiktionary page for “h3h3”",
      "[news/recent-articles] Google News: 0 items in last 60d (40 returned) for “h3h3 creator”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “h3h3 creator”",
      "[bluesky/discussion-volume] Bluesky search unavailable for \"h3h3 creator\"",
    ...
    scoreReasons: {
      relevance: "Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (40 returned) for “h3h3 creator”)",
