...
const entry: BaseEntry = {
  ...
  scores: { relevance: 28, influence: 88, cringe: 55, brainrot: 41 },
  dynamicMetadata: {
    ...
    popularityNotes: "Status: classic · Relevance 28 (today's recognition, not influence) · Trending 17 (recent attention)",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 0 items in last 30d (40 returned) for “Stan Twitter Culture”",
