...
const entry: BaseEntry = {
  ...
  scores: { relevance: 32, influence: 68, cringe: 35, brainrot: 32 },
  dynamicMetadata: {
    ...
    trendingScore: 25,
    recentRevival: false,
    popularityNotes: "Status: occasionally-referenced · Relevance 32 (today's recognition, not influence) · Trending 25 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=2,750 for “Coquette aesthetic”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=626 prev7=642 (-2%)",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/authority-documentation] No Wiktionary page for “Coquette”",
      "[news/recent-articles] Google News: 1 items in last 30d (40 returned) for “Coquette Aesthetic”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Coquette Aesthetic”",
