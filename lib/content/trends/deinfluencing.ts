...
const entry: BaseEntry = {
  ...
  scores: { relevance: 29, influence: 72, cringe: 25, brainrot: 32 },
  dynamicMetadata: {
    ...
    evidenceNotes: [
      "[wikipedia/search-interest] No confident English Wikipedia match for “Deinfluencing”",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/authority-documentation] No Wiktionary page for “Deinfluencing”",
      "[news/recent-articles] Google News: 3 items in last 30d (40 returned) for “Deinfluencing”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Deinfluencing”",
