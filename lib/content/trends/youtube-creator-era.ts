...
const entry: BaseEntry = {
  ...
  dynamicMetadata: {
    ...
    popularityNotes: "Status: classic · Relevance 40 (today's recognition, not influence) · Trending 35 (recent attention)",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 4 items in last 30d (40 returned) for “YouTube Creator Era”",
