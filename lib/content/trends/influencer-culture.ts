...
const entry: BaseEntry = {
  ...
  dynamicMetadata: {
    ...
    popularityNotes: "Status: classic · Relevance 35 (today's recognition, not influence) · Trending 37 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] No confident English Wikipedia match for “Influencer Culture”",
      ...
      "[news/recent-articles] Google News: 8 items in last 30d (40 returned) for “Influencer Culture”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Influencer Culture”",
