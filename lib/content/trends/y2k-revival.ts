...
const entry: BaseEntry = {
  ...
  scores: { relevance: 65, influence: 70, cringe: 32, brainrot: 51 },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=55 (Google News: 10 items in last 60d (40 returned) for “Y2K Revival”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 10 items in last 60d (40 returned) for “Y2K Revival”",
      ...
      "[bluesky/discussion-volume] Bluesky search unavailable for \"Y2K Revival\"",
      "[youtube/recent-uploads] YOUTUBE_DATA_API_KEY not set — YouTube live search skipped",
      "[catalog-evidence/gen-cohort-adoption] Cohort cue from tags/title (brainrot character only)",
      "Weak corroboration — blended heuristic (71) with AI double-check (58): Documentation and news signals are moderate but low Google Trends and adoption cues suggest the Y2K Revival is noticeable yet not currently a high‑spike trend.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=55 (Google News: 10 items in last 60d (40 returned) for “Y2K Revival”)",
