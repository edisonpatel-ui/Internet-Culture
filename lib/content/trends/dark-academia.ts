...
const entry: BaseEntry = {
  ...
  dynamicMetadata: {
    ...
    popularityNotes: "Status: occasionally-referenced · Relevance 34 (today's recognition, not influence) · Trending 36 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikipedia page “Dark academia” found but pageviews unavailable",
      ...
      "[news/recent-articles] Google News: 7 items in last 30d (40 returned) for “Dark Academia”",
