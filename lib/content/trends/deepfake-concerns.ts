...
const entry: BaseEntry = {
  ...
  scores: { relevance: 75, influence: 83, cringe: 19, brainrot: 58 },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=69 (Google News: 20 items in last 60d (40 returned) for “Deepfake Concerns”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Character signals still mark this as strongly representative of chaotic internet brainrot culture. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] No confident English Wikipedia match for “Deepfake Concerns”",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/authority-documentation] Wiktionary page “Deepfake”",
      "[dictionary/platform-activity] Wiktionary last revision 2026-05-11",
      "[news/recent-articles] Google News: 20 items in last 60d (40 returned) for “Deepfake Concerns”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Deepfake Concerns”",
      "[bluesky/discussion-volume] Bluesky search unavailable for \"Deepfake Concerns\"",
      "[youtube/recent-uploads] YOUTUBE_DATA_API_KEY not set — YouTube live search skipped",
      "[catalog-evidence/remix-activity] Format/remix / short-form reuse cue (brainrot character only)",
      "Weak corroboration — blended heuristic (87) with AI double-check (62): While authoritative documentation and recent news show solid interest, low Google‑Trends activity and modest platform engagement indicate only moderate current popularity.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=69 (Google News: 20 items in last 60d (40 returned) for “Deepfake Concerns”)",
