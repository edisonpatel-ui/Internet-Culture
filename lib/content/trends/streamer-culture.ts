...
const entry: BaseEntry = {
  ...
  scores: { relevance: 65, influence: 88, cringe: 40, brainrot: 34 },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Creation volume is not peaking, but new content is still being produced regularly. Signals: news/recent-articles=50 (Google News: 8 items in last 60d (40 returned) for “Streamer Culture”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 8 items in last 60d (40 returned) for “Streamer Culture”",
      ...
      "[bluesky/discussion-volume] Bluesky search unavailable for \"Streamer Culture\"",
    ...
    scoreReasons: {
      relevance: "Creation volume is not peaking, but new content is still being produced regularly. Signals: news/recent-articles=50 (Google News: 8 items in last 60d (40 returned) for “Streamer Culture”)",
