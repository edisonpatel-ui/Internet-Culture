...
const entry: MemeEntry = {
  ...
  scores: { relevance: 58, influence: 88, cringe: 21, brainrot: 51 },
  dynamicMetadata: {
    ...
    evidenceNotes: [
      ...
      "[dictionary/authority-documentation] Wiktionary page “Wojak”",
      "[dictionary/platform-activity] Wiktionary last revision 2026-07-05",
      "[news/recent-articles] Google News: 7 items in last 60d (40 returned) for “Wojak meme”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Wojak meme”",
      "[youtube/recent-uploads] YOUTUBE_DATA_API_KEY not set — YouTube live search skipped",
      "Weak corroboration — blended heuristic (61) with AI double-check (55): Wojak maintains a steady baseline presence across reference sites but shows declining pageviews and low Google‑Trends activity, indicating modest but not heightened current popularity.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=47 (Google News: 7 items in last 60d (40 returned) for “Wojak meme”)",
