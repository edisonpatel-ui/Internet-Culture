...
const entry: MemeEntry = {
  ...
  scores: { relevance: 43, influence: 88, cringe: 21, brainrot: 51 },
  dynamicMetadata: {
    ...
    trendingScore: 36,
    recentRevival: false,
    popularityNotes: "Status: classic · Relevance 43 (today's recognition, not influence) · Trending 36 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=27,083 for “Wojak”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=6253 prev7=6098 (3%)",
      ...
      "[news/recent-articles] Google News: 3 items in last 30d (40 returned) for “Wojak”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Wojak”",
