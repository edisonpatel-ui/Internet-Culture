...
const entry: MemeEntry = {
  ...
  scores: { relevance: 62, influence: 80, cringe: 21, brainrot: 26 },
  timelineEntry: {
    featured: true,
    datePrecision: "exact",
    sortDate: "2013-01-09",
    whyItMatters:
      "Became the internet's default visual shorthand for calm denial amid chaos, still in constant use.",
  },
  dynamicMetadata: {
    ...
    trendingScore: 43,
    recentRevival: false,
    popularityNotes: "Relevance: Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=52 (Google News: 9 items in last 60d (40 returned) for “This Is Fine”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=140 for “This Is Fine”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=23 prev7=32 (-28%)",
      ...
      "[news/recent-articles] Google News: 9 items in last 60d (40 returned) for “This Is Fine”",
      ...
      "Weak corroboration — blended heuristic (67) with AI double-check (56): Baseline meme awareness remains moderate, but declining pageviews and low Google Trends indicate current interest is fading despite recent documentation activity.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=52 (Google News: 9 items in last 60d (40 returned) for “This Is Fine”)",
