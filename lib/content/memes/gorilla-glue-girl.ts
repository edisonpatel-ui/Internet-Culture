...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    evidenceNotes: [
      ...
      "[dictionary/platform-activity] Wiktionary lookup unavailable for “Gorilla”",
      "[news/recent-articles] Google News: 0 items in last 30d (40 returned) for “Gorilla Glue Girl”",
