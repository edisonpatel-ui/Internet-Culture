...
const entry: MemeEntry = {
  ...
  scores: { relevance: 34, influence: 92, cringe: 21, brainrot: 41 },
  dynamicMetadata: {
    ...
    trendingScore: 20,
    recentRevival: false,
    popularityNotes: "Status: historical · Relevance 34 (today's recognition, not influence) · Trending 20 (recent attention)",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 0 items in last 30d (40 returned) for “Hamster Dance”",
