...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    trendingScore: 27,
    recentRevival: false,
    popularityNotes: "Relevance: Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (40 returned) for “Hamster Dance”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      ...
      "[dictionary/authority-documentation] Wiktionary page “Hamster”",
      "[dictionary/platform-activity] Wiktionary last revision 2026-05-29",
      "[news/recent-articles] Google News: 0 items in last 60d (40 returned) for “Hamster Dance”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Hamster Dance”",
      "[youtube/recent-uploads] YOUTUBE_DATA_API_KEY not set — YouTube live search skipped",
      "[catalog-evidence/absurdity] Tag/title absurdity cue (brainrot character only)",
      "Weak corroboration — blended heuristic (0) with AI double-check (12): Recent signals show virtually no news coverage, low search/trend activity, and only archival documentation, indicating minimal current popularity.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (40 returned) for “Hamster Dance”)",
