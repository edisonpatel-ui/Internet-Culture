...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    trendingScore: 55,
    recentRevival: false,
    popularityNotes: "Status: classic · Relevance 43 (today's recognition, not influence) · Trending 55 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=1,185 for “Fred”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=293 prev7=265 (11%)",
      ...
      "[news/recent-articles] Google News: 40 items in last 30d (40 returned) for “Fred”",
      "[creator-pages/recent-uploads] No YouTube channel_id URLs on entry sources — creator RSS skipped",
      "[authority-sources/authority-documentation] Know Your Meme cited",
      "[google-trends/search-interest] Not on current Google US Trending RSS (10 topics) — not treated as zero search interest",
      "[google-trends/editorial-trend] Absence from daily trending list → not currently spiking",
      "[reddit/discussion-volume] Reddit search unavailable for “Fred”",
