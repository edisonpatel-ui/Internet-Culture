...
const entry: MemeEntry = {
  ...
  scores: { relevance: 35, influence: 84, cringe: 21, brainrot: 32 },
  dynamicMetadata: {
    ...
    trendingScore: 32,
    recentRevival: false,
    popularityNotes: "Status: classic · Relevance 35 (today's recognition, not influence) · Trending 32 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=13,873 for “Nyan Cat”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=3285 prev7=3594 (-9%)",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/authority-documentation] No Wiktionary page for “Nyan”",
      "[news/recent-articles] Google News: 3 items in last 30d (40 returned) for “Nyan Cat”",
