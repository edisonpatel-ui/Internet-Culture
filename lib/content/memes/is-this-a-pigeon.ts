...
const entry: MemeEntry = {
  ...
  scores: { relevance: 0, influence: 78, cringe: 21, brainrot: 58 },
  dynamicMetadata: {
    ...
    trendingScore: 20,
    recentRevival: false,
    popularityNotes: "Relevance: Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (40 returned) for “Is This a Pigeon?”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Character signals still mark this as strongly representative of chaotic internet brainrot culture. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=2,984 for “Is this a pigeon?”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=618 prev7=737 (-16%)",
      ...
      "[news/recent-articles] Google News: 0 items in last 60d (40 returned) for “Is This a Pigeon?”",
    ...
    scoreReasons: {
      relevance: "Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (40 returned) for “Is This a Pigeon?”)",
