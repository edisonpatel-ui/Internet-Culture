...
const entry: MemeEntry = {
  ...
  scores: { relevance: 25, influence: 68, cringe: 49, brainrot: 95 },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Recent creation signals rose modestly. Signals: news/recent-articles=16 (Google News: 1 items in last 60d (32 returned) for “Quandale Dingle”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Character signals still mark this as strongly representative of chaotic internet brainrot culture. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 1 items in last 60d (32 returned) for “Quandale Dingle”",
    ...
    scoreReasons: {
      relevance: "Recent creation signals rose modestly. Signals: news/recent-articles=16 (Google News: 1 items in last 60d (32 returned) for “Quandale Dingle”)",
