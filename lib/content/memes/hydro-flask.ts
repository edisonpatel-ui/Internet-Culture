...
const entry: MemeEntry = {
  ...
  scores: { relevance: 71, influence: 60, cringe: 21, brainrot: 45 },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=66 (Google News: 17 items in last 60d (40 returned) for “Hydro Flask”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Character signals still mark this as strongly representative of chaotic internet brainrot culture. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikipedia page “Hydro Flask” found but pageviews unavailable",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/authority-documentation] No Wiktionary page for “Hydro”",
      "[news/recent-articles] Google News: 17 items in last 60d (40 returned) for “Hydro Flask”",
      ...
      "Weak corroboration — blended heuristic (84) with AI double-check (58): Mixed signals—moderate news and documentation but low Google Trends and platform activity suggest current popularity is only mid‑range, not the high 80s the heuristic claims.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=66 (Google News: 17 items in last 60d (40 returned) for “Hydro Flask”)",
