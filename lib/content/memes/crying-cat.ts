...
const entry: MemeEntry = {
  ...
  scores: { relevance: 58, influence: 72, cringe: 21, brainrot: 32 },
  dynamicMetadata: {
    ...
    trendingScore: 49,
    recentRevival: false,
    popularityNotes: "Relevance: Recent creation signals rose modestly. Signals: news/recent-articles=44 (Google News: 6 items in last 60d (40 returned) for “Crying Cat”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 6 items in last 60d (40 returned) for “Crying Cat”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Crying Cat”",
    ...
    scoreReasons: {
      relevance: "Recent creation signals rose modestly. Signals: news/recent-articles=44 (Google News: 6 items in last 60d (40 returned) for “Crying Cat”)",
