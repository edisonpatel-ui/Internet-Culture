...
const entry: MemeEntry = {
  ...
  scores: { relevance: 30, influence: 92, cringe: 21, brainrot: 32 },
  dynamicMetadata: {
    ...
    popularityNotes: "Status: historical · Relevance 30 (today's recognition, not influence) · Trending 31 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] No confident English Wikipedia match for “Dancing Baby”",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/platform-activity] Wiktionary lookup unavailable for “Dancing”",
      "[news/recent-articles] Google News: 4 items in last 30d (40 returned) for “Dancing Baby”",
