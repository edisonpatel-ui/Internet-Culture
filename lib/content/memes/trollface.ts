...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 1 items in last 60d (40 returned) for “Trollface meme”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Trollface meme”",
      "[youtube/recent-uploads] YOUTUBE_DATA_API_KEY not set — YouTube live search skipped",
      "Weak corroboration — blended heuristic (25) with AI double-check (22): The modest Wikipedia traffic and slight week‑over‑week rise are outweighed by minimal news coverage, low Google Trends activity, and stale KYM updates, indicating only low residual interest.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Little recent creation activity detected. Signals: news/recent-articles=16 (Google News: 1 items in last 60d (40 returned) for “Trollface meme”)",
