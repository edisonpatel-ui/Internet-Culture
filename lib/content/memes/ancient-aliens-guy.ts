...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    trendingScore: 20,
    recentRevival: false,
    popularityNotes: "Status: classic · Relevance 31 (today's recognition, not influence) · Trending 20 (recent attention)",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 0 items in last 30d (40 returned) for “Ancient Aliens Guy”",
