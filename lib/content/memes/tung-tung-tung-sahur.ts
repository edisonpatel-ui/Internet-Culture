...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    trendingScore: 38,
    recentRevival: false,
    popularityNotes: "Status: occasionally-referenced · Relevance 41 (today's recognition, not influence) · Trending 38 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=178,573 for “Tung Tung Tung Sahur”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=32103 prev7=34005 (-6%)",
      ...
      "[news/recent-articles] Google News: 5 items in last 30d (40 returned) for “Tung Tung Tung Sahur”",
