...
const entry: MemeEntry = {
  ...
  scores: { relevance: 66, influence: 62, cringe: 21, brainrot: 32 },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=57 (Google News: 11 items in last 60d (40 returned) for “omni man”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      ...
      "[dictionary/authority-documentation] No Wiktionary page for “Omni-Man”",
      "[news/recent-articles] Google News: 11 items in last 60d (40 returned) for “omni man”",
      ...
      "Weak corroboration — blended heuristic (73) with AI double-check (58): Documentation and news presence are moderate, but low platform activity and trend data suggest the meme isn’t currently at peak popularity.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=57 (Google News: 11 items in last 60d (40 returned) for “omni man”)",
