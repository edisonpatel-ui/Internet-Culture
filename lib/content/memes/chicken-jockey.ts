...
const entry: MemeEntry = {
  ...
  scores: { relevance: 28, influence: 70, cringe: 21, brainrot: 72 },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Little recent creation activity detected. Signals: news/recent-articles=16 (Google News: 1 items in last 60d (40 returned) for “Chicken Jockey”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Character signals still mark this as strongly representative of chaotic internet brainrot culture. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 1 items in last 60d (40 returned) for “Chicken Jockey”",
      ...
      "Weak corroboration — blended heuristic (25) with AI double-check (30): While the meme has documented entries and some absurdity cues, recent news, search trends, and platform activity are low, indicating limited current popularity.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Little recent creation activity detected. Signals: news/recent-articles=16 (Google News: 1 items in last 60d (40 returned) for “Chicken Jockey”)",
