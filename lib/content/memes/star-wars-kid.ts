...
const entry: MemeEntry = {
  ...
  scores: { relevance: 80, influence: 84, cringe: 24, brainrot: 21 },
  timelineEntry: {
    featured: true,
    datePrecision: "exact",
    sortDate: "2003-04-14",
    whyItMatters:
      "One of the first viral videos to become a real-world cautionary tale about internet fame and harassment.",
  },
  dynamicMetadata: {
    ...
    trendingScore: 56,
    recentRevival: false,
    popularityNotes: "Relevance: Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=63 (Google News: 15 items in last 60d (40 returned) for “Star Wars Kid”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=3,890 for “Star Wars Kid”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=937 prev7=959 (-2%)",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/authority-documentation] Wiktionary page “Star”",
      "[dictionary/platform-activity] Wiktionary last revision 2026-07-10",
      "[news/recent-articles] Google News: 15 items in last 60d (40 returned) for “Star Wars Kid”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Star Wars Kid”",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=63 (Google News: 15 items in last 60d (40 returned) for “Star Wars Kid”)",
