...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    trendingScore: 37,
    recentRevival: false,
    popularityNotes: "Status: classic · Relevance 42 (today's recognition, not influence) · Trending 37 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=5,709 for “Star Wars Kid”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=905 prev7=857 (6%)",
      ...
      "[news/recent-articles] Google News: 4 items in last 30d (40 returned) for “Star Wars Kid”",
