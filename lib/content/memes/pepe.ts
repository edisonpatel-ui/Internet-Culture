...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=26,475 for “Pepe the Frog”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=5864 prev7=6268 (-6%)",
      ...
      "[news/recent-articles] Google News: 0 items in last 30d (40 returned) for “Pepe the Frog”",
