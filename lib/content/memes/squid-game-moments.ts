...
const entry: MemeEntry = {
  ...
  scores: { relevance: 8, influence: 72, cringe: 62, brainrot: 60 },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (40 returned) for “Squid Game Moments”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 0 items in last 60d (40 returned) for “Squid Game Moments”",
      ...
      "Weak corroboration — blended heuristic (0) with AI double-check (15): Documentation remains but recent news, trends, and platform activity are minimal, indicating the meme is largely past its peak.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (40 returned) for “Squid Game Moments”)",
