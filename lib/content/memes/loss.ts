...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 13 items in last 60d (40 returned) for “Loss meme”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Loss meme”",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=60 (Google News: 13 items in last 60d (40 returned) for “Loss meme”)",
