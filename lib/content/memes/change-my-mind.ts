...
const entry: MemeEntry = {
  ...
  scores: { relevance: 74, influence: 79, cringe: 21, brainrot: 58 },
  timelineEntry: {
    featured: true,
    datePrecision: "month",
    sortDate: "2018-02-01",
    whyItMatters:
      "A photo of a debate sign that became a widely reused template for stating an opinion.",
  },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=67 (Google News: 18 items in last 60d (40 returned) for “Change My Mind”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Character signals still mark this as strongly representative of chaotic internet brainrot culture. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikipedia page “Change My Mind” found but pageviews unavailable",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/authority-documentation] No Wiktionary page for “Change”",
      "[news/recent-articles] Google News: 18 items in last 60d (40 returned) for “Change My Mind”",
      ...
      "Weak corroboration — blended heuristic (85) with AI double-check (62): Mixed signals show moderate ongoing interest (news, KYM, Wikipedia) but low Google Trends and limited remix activity, so popularity is lower than the heuristic's 85.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=67 (Google News: 18 items in last 60d (40 returned) for “Change My Mind”)",
