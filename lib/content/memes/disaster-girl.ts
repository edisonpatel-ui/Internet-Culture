...
const entry: MemeEntry = {
  ...
  scores: { relevance: 32, influence: 78, cringe: 21, brainrot: 26 },
  dynamicMetadata: {
    ...
    trendingScore: 25,
    recentRevival: false,
    popularityNotes: "Status: historical · Relevance 32 (today's recognition, not influence) · Trending 25 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=10,291 for “Disaster Girl”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=2459 prev7=2375 (4%)",
      ...
      "[news/recent-articles] Google News: 1 items in last 30d (40 returned) for “Disaster Girl”",
