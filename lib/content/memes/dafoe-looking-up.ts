...
const entry: MemeEntry = {
  ...
  scores: { relevance: 18, influence: 60, cringe: 21, brainrot: 21 },
  dynamicMetadata: {
    ...
    popularityNotes: "Status: occasionally-referenced · Relevance 18 (today's recognition, not influence) · Trending 12 (recent attention)",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 0 items in last 30d (40 returned) for “Dafoe Looking Up”",
