...
const entry: MemeEntry = {
  ...
  scores: { relevance: 36, influence: 60, cringe: 21, brainrot: 21 },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Recent creation signals rose modestly. Signals: news/recent-articles=25 (Google News: 2 items in last 60d (40 returned) for “Dafoe Looking Up”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] No confident English Wikipedia match for “Dafoe Looking Up”",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/authority-documentation] Wiktionary page “Dafoe”",
      "[dictionary/platform-activity] Wiktionary last revision 2022-07-09",
      "[news/recent-articles] Google News: 2 items in last 60d (40 returned) for “Dafoe Looking Up”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Dafoe Looking Up”",
    ...
    scoreReasons: {
      relevance: "Recent creation signals rose modestly. Signals: news/recent-articles=25 (Google News: 2 items in last 60d (40 returned) for “Dafoe Looking Up”)",
