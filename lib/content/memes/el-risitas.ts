...
const entry: MemeEntry = {
  ...
  scores: { relevance: 0, influence: 70, cringe: 21, brainrot: 34 },
  dynamicMetadata: {
    ...
    trendingScore: 22,
    recentRevival: false,
    popularityNotes: "Relevance: Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (40 returned) for “El Risitas”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=3,801 for “El Risitas”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=776 prev7=876 (-11%)",
      ...
      "[news/recent-articles] Google News: 0 items in last 60d (40 returned) for “El Risitas”",
    ...
    scoreReasons: {
      relevance: "Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (40 returned) for “El Risitas”)",
