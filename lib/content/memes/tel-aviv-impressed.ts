...
const entry: MemeEntry = {
  ...
  scores: { relevance: 25, influence: 42, cringe: 37, brainrot: 81 },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Little recent creation activity detected. Signals: news/recent-articles=16 (Google News: 1 items in last 60d (40 returned) for “Tel Aviv Impressed”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Character signals still mark this as strongly representative of chaotic internet brainrot culture. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 1 items in last 60d (40 returned) for “Tel Aviv Impressed”",
    ...
    scoreReasons: {
      relevance: "Little recent creation activity detected. Signals: news/recent-articles=16 (Google News: 1 items in last 60d (40 returned) for “Tel Aviv Impressed”)",
