...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    trendingScore: 28,
    recentRevival: false,
    popularityNotes: "Status: historical · Relevance 38 (today's recognition, not influence) · Trending 28 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=4,687 for “Charlie the Unicorn”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=1009 prev7=1070 (-6%)",
      ...
      "[news/recent-articles] Google News: 1 items in last 30d (40 returned) for “Charlie the Unicorn”",
      "[creator-pages/recent-uploads] No YouTube channel_id URLs on entry sources — creator RSS skipped",
      "[authority-sources/authority-documentation] Know Your Meme cited",
      "[google-trends/search-interest] Not on current Google US Trending RSS (10 topics) — not treated as zero search interest",
      "[google-trends/editorial-trend] Absence from daily trending list → not currently spiking",
      "[reddit/discussion-volume] Reddit search unavailable for “Charlie the Unicorn”",
