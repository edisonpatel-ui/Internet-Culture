...
const entry: MemeEntry = {
  ...
  scores: { relevance: 80, influence: 94, cringe: 31, brainrot: 26 },
  timelineEntry: {
    featured: true,
    datePrecision: "exact",
    sortDate: "2012-07-15",
    whyItMatters:
      "First YouTube video to hit 1 billion views, a landmark moment for global viral video culture.",
  },
  dynamicMetadata: {
    ...
    trendingScore: 54,
    recentRevival: false,
    popularityNotes: "Relevance: Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=63 (Google News: 15 items in last 60d (40 returned) for “Gangnam Style”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=29,653 for “Gangnam Style”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=6333 prev7=7001 (-10%)",
      ...
      "[news/recent-articles] Google News: 15 items in last 60d (40 returned) for “Gangnam Style”",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=63 (Google News: 15 items in last 60d (40 returned) for “Gangnam Style”)",
