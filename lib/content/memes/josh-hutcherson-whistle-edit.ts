...
const entry: MemeEntry = {
  ...
  scores: { relevance: 20, influence: 58, cringe: 21, brainrot: 26 },
  dynamicMetadata: {
    ...
    popularityNotes: "Status: classic · Relevance 20 (today's recognition, not influence) · Trending 14 (recent attention)",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 0 items in last 30d (28 returned) for “Josh Hutcherson \"Whistle\" Edit”",
