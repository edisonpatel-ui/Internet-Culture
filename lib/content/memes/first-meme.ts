...
const entry: MemeEntry = {
  ...
  scores: { relevance: 80, influence: 75, cringe: 21, brainrot: 40 },
  dynamicMetadata: {
    ...
    evidenceNotes: [
      ...
      "[dictionary/authority-documentation] Wiktionary page “First”",
      "[dictionary/platform-activity] Wiktionary last revision 2025-12-06",
      "[news/recent-articles] Google News: 15 items in last 60d (40 returned) for “First Meme”",
      "[creator-pages/recent-uploads] No YouTube channel_id URLs on entry sources — creator RSS skipped",
      "[authority-sources/authority-documentation] Major news organization cited; Wikipedia / Wikimedia cited",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=63 (Google News: 15 items in last 60d (40 returned) for “First Meme”)",
