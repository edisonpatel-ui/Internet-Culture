...
const entry: MemeEntry = {
  ...
  scores: { relevance: 38, influence: 48, cringe: 21, brainrot: 41 },
  dynamicMetadata: {
    ...
    trendingScore: 39,
    recentRevival: false,
    popularityNotes: "Status: occasionally-referenced · Relevance 38 (today's recognition, not influence) · Trending 39 (recent attention)",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 8 items in last 30d (40 returned) for “Zendaya Theory”",
