...
const entry: MemeEntry = {
  ...
  scores: { relevance: 86, influence: 67, cringe: 39, brainrot: 30 },
  dynamicMetadata: {
    ...
    trendingScore: 59,
    recentRevival: false,
    popularityNotes: "Relevance: Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=68 (Google News: 19 items in last 60d (40 returned) for “One Does Not Simply”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 19 items in last 60d (40 returned) for “One Does Not Simply”",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=68 (Google News: 19 items in last 60d (40 returned) for “One Does Not Simply”)",
