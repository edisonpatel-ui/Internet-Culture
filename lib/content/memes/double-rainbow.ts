...
const entry: MemeEntry = {
  ...
  scores: { relevance: 37, influence: 78, cringe: 21, brainrot: 34 },
  dynamicMetadata: {
    ...
    trendingScore: 38,
    recentRevival: false,
    popularityNotes: "Status: classic · Relevance 37 (today's recognition, not influence) · Trending 38 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=4,758 for “Double Rainbow (viral video)”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=905 prev7=994 (-9%)",
      ...
      "[news/recent-articles] Google News: 7 items in last 30d (40 returned) for “Double Rainbow”",
