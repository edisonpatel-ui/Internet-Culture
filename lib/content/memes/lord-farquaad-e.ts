...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    trendingScore: 23,
    recentRevival: false,
    popularityNotes: "Status: occasionally-referenced · Relevance 39 (today's recognition, not influence) · Trending 23 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=61,124 for “Internet meme”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=13912 prev7=13491 (3%)",
      ...
      "[news/recent-articles] Google News: 0 items in last 30d (19 returned) for “Lord Farquaad E”",
