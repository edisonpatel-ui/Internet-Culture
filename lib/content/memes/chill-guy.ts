...
const entry: MemeEntry = {
  ...
  timelineEntry: {
    ...
    sortDate: "2024-11-01",
    whyItMatters:
      "Rapid, massive viral spread illustrating how fast modern algorithmic meme cycles move.",
  },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=85 (Google News: 40 items in last 60d (40 returned) for “Chill Guy”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikipedia page “Chill Guy” found but pageviews unavailable",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/authority-documentation] Wiktionary page “Chill”",
      "[dictionary/platform-activity] Wiktionary last revision 2022-07-09",
      "[news/recent-articles] Google News: 40 items in last 60d (40 returned) for “Chill Guy”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Chill Guy”",
      "[youtube/recent-uploads] YOUTUBE_DATA_API_KEY not set — YouTube live search skipped",
      "Weak corroboration — blended heuristic (100) with AI double-check (70): Strong news coverage and documentation suggest high visibility, but low Google Trends and platform activity temper the hype, leading to a moderate‑high popularity estimate.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=85 (Google News: 40 items in last 60d (40 returned) for “Chill Guy”)",
