...
const entry: MemeEntry = {
  ...
  scores: { relevance: 30, influence: 85, cringe: 21, brainrot: 21 },
  dynamicMetadata: {
    ...
    trendingScore: 27,
    recentRevival: false,
    popularityNotes: "Status: occasionally-referenced · Relevance 30 (today's recognition, not influence) · Trending 27 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=8,150 for “Chill Guy”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=1790 prev7=1853 (-3%)",
      ...
      "[news/recent-articles] Google News: 2 items in last 30d (40 returned) for “Chill Guy”",
