...
const entry: MemeEntry = {
  ...
  scores: { relevance: 41, influence: 76, cringe: 21, brainrot: 32 },
  dynamicMetadata: {
    ...
    trendingScore: 26,
    recentRevival: true,
    popularityNotes: "Status: classic · Relevance 41 (today's recognition, not influence) · Trending 26 (recent attention) · Recent revival signal",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=14,606 for “Hide the Pain Harold”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=6676 prev7=2328 (187%)",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/authority-documentation] No Wiktionary page for “Hide”",
      "[news/recent-articles] Google News: 0 items in last 30d (40 returned) for “Hide the Pain Harold”",
