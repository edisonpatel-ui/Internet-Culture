...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 6 items in last 60d (40 returned) for “Doge meme”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Doge meme”",
      "[youtube/recent-uploads] YOUTUBE_DATA_API_KEY not set — YouTube live search skipped",
      "Weak corroboration — blended heuristic (58) with AI double-check (48): Steady baseline interest shown by modest pageviews and recent dictionary updates, but declining trends and low news/Google‑Trends activity indicate the meme isn’t currently spiking.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Recent creation signals rose modestly. Signals: news/recent-articles=44 (Google News: 6 items in last 60d (40 returned) for “Doge meme”)",
