...
const entry: MemeEntry = {
  ...
  timelineEntry: {
    ...
    sortDate: "2016-06-17",
    whyItMatters:
      "Crossed from kids' content into global viral phenomenon, becoming the most-viewed YouTube video ever.",
  },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=81 (Google News: 34 items in last 60d (40 returned) for “Baby Shark”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikipedia page “Baby Shark” found but pageviews unavailable",
      ...
      "[news/recent-articles] Google News: 34 items in last 60d (40 returned) for “Baby Shark”",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=81 (Google News: 34 items in last 60d (40 returned) for “Baby Shark”)",
