...
const entry: MemeEntry = {
  ...
  scores: { relevance: 93, influence: 50, cringe: 21, brainrot: 41 },
  dynamicMetadata: {
    ...
    trendingScore: 71,
    recentRevival: false,
    popularityNotes: "Relevance: Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=79 (Google News: 31 items in last 60d (40 returned) for “Boston Dynamics Robot”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=4,946 for “Michael Reeves (internet personality)”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=1529 prev7=1256 (22%)",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/authority-documentation] Wiktionary page “Boston”",
      "[dictionary/platform-activity] Wiktionary last revision 2026-07-27",
      "[news/recent-articles] Google News: 31 items in last 60d (40 returned) for “Boston Dynamics Robot”",
    ...
    scoreReasons: {
      relevance: "Ongoing new posts/uploads/discussion support steady Current Relevance. Signals: news/recent-articles=79 (Google News: 31 items in last 60d (40 returned) for “Boston Dynamics Robot”)",
