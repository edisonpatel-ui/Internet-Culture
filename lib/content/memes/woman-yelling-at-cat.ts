...
const entry: MemeEntry = {
  ...
  scores: { relevance: 50, influence: 82, cringe: 21, brainrot: 32 },
  timelineEntry: {
    featured: true,
    datePrecision: "month",
    sortDate: "2019-10-01",
    whyItMatters:
      "One of the most widely-remixed reaction meme templates of the late 2010s.",
  },
  dynamicMetadata: {
    ...
    trendingScore: 47,
    recentRevival: false,
    popularityNotes: "Relevance: Recent creation signals rose modestly. Signals: news/recent-articles=37 (Google News: 4 items in last 60d (40 returned) for “Woman Yelling at Cat”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=15,468 for “Woman yelling at a cat”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=3866 prev7=3479 (11%)",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/authority-documentation] No Wiktionary page for “Woman”",
      "[news/recent-articles] Google News: 4 items in last 60d (40 returned) for “Woman Yelling at Cat”",
    ...
    scoreReasons: {
      relevance: "Recent creation signals rose modestly. Signals: news/recent-articles=37 (Google News: 4 items in last 60d (40 returned) for “Woman Yelling at Cat”)",
