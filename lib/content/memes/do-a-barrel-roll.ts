...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    trendingScore: 39,
    recentRevival: false,
    popularityNotes: "Status: classic · Relevance 45 (today's recognition, not influence) · Trending 39 (recent attention)",
    evidenceNotes: [
      ...
      "[dictionary/authority-documentation] Wiktionary page “Do”",
      "[dictionary/platform-activity] Wiktionary last revision 2026-07-12",
      "[news/recent-articles] Google News: 4 items in last 30d (40 returned) for “Do a Barrel Roll”",
      "[creator-pages/recent-uploads] No YouTube channel_id URLs on entry sources — creator RSS skipped",
      "[authority-sources/authority-documentation] Know Your Meme cited",
      "[google-trends/search-interest] Not on current Google US Trending RSS (10 topics) — not treated as zero search interest",
      "[google-trends/editorial-trend] Absence from daily trending list → not currently spiking",
      "[reddit/discussion-volume] Reddit search unavailable for “Do a Barrel Roll”",
