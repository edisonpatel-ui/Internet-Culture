...
const entry: MemeEntry = {
  ...
  scores: { relevance: 0, influence: 48, cringe: 21, brainrot: 45 },
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (6 returned) for “Wilson Lo Siento”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Character signals still mark this as strongly representative of chaotic internet brainrot culture. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 0 items in last 60d (6 returned) for “Wilson Lo Siento”",
    ...
    scoreReasons: {
      relevance: "Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (6 returned) for “Wilson Lo Siento”)",
