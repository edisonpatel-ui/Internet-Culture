...
const entry: MemeEntry = {
  ...
  scores: { relevance: 36, influence: 79, cringe: 27, brainrot: 31 },
  dynamicMetadata: {
    ...
    trendingScore: 40,
    recentRevival: false,
    popularityNotes: "Relevance: Recent creation signals rose modestly. Signals: news/recent-articles=25 (Google News: 2 items in last 60d (40 returned) for “Bad Luck Brian”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=3,850 for “Bad Luck Brian”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=1170 prev7=1099 (6%)",
      "[know-your-meme/authority-documentation] Know Your Meme entry located",
      "[know-your-meme/platform-activity] KYM entry exists; last-updated date not parseable",
      "[dictionary/authority-documentation] Wiktionary page “Bad”",
      "[dictionary/platform-activity] Wiktionary last revision 2026-07-21",
      "[news/recent-articles] Google News: 2 items in last 60d (40 returned) for “Bad Luck Brian”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Bad Luck Brian”",
    ...
    scoreReasons: {
      relevance: "Recent creation signals rose modestly. Signals: news/recent-articles=25 (Google News: 2 items in last 60d (40 returned) for “Bad Luck Brian”)",
