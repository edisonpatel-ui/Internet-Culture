...
const entry: MemeEntry = {
  ...
  scores: { relevance: 30, influence: 79, cringe: 27, brainrot: 31 },
  dynamicMetadata: {
    ...
    trendingScore: 28,
    recentRevival: false,
    popularityNotes: "Status: classic · Relevance 38 (today's recognition, not influence) · Trending 28 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=3,377 for “Bad Luck Brian”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=742 prev7=788 (-6%)",
      ...
      "[news/recent-articles] Google News: 1 items in last 30d (40 returned) for “Bad Luck Brian”",
