...
const entry: MemeEntry = {
  ...
  scores: { relevance: 50, influence: 72, cringe: 21, brainrot: 20 },
  dynamicMetadata: {
    ...
    trendingScore: 42,
    recentRevival: false,
    popularityNotes: "Relevance: Recent creation signals rose modestly. Signals: news/recent-articles=37 (Google News: 4 items in last 60d (40 returned) for “Stop It, Get Some Help”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=1,778 for “Stop it. Get some help.”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=415 prev7=446 (-7%)",
      ...
      "[news/recent-articles] Google News: 4 items in last 60d (40 returned) for “Stop It, Get Some Help”",
    ...
    scoreReasons: {
      relevance: "Recent creation signals rose modestly. Signals: news/recent-articles=37 (Google News: 4 items in last 60d (40 returned) for “Stop It, Get Some Help”)",
