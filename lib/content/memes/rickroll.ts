...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 0 items in last 60d (40 returned) for “Rickroll meme”",
      ...
      "[reddit/discussion-volume] Reddit search unavailable for “Rickroll meme”",
      "[youtube/recent-uploads] YOUTUBE_DATA_API_KEY not set — YouTube live search skipped",
      "Weak corroboration — blended heuristic (0) with AI double-check (12): While the meme has strong historical documentation, recent news, trends, and platform activity are minimal, indicating low current popularity.",
    ],
    providersUsed: [
      "wikipedia",
      "know-your-meme",
    ...
    scoreReasons: {
      relevance: "Little recent creation activity detected. Signals: news/recent-articles=0 (Google News: 0 items in last 60d (40 returned) for “Rickroll meme”)",
