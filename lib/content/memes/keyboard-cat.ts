...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    trendingScore: 20,
    recentRevival: false,
    popularityNotes: "Status: classic · Relevance 34 (today's recognition, not influence) · Trending 20 (recent attention)",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikimedia pageviews 30d=7,838 for “Keyboard Cat”",
      "[wikipedia/editorial-trend] Pageviews WoW last7=1921 prev7=1831 (5%)",
      ...
      "[news/recent-articles] Google News: 0 items in last 30d (40 returned) for “Keyboard Cat”",
