...
const entry: MemeEntry = {
  ...
  scores: { relevance: 44, influence: 68, cringe: 21, brainrot: 32 },
  dynamicMetadata: {
    ...
    trendingScore: 37,
    recentRevival: false,
    popularityNotes: "Relevance: Recent creation signals rose modestly. Signals: news/recent-articles=32 (Google News: 3 items in last 60d (40 returned) for “OK Hand Sign”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      ...
      "[dictionary/authority-documentation] Wiktionary page “OK”",
      "[dictionary/platform-activity] Wiktionary last revision 2026-08-10",
      "[news/recent-articles] Google News: 3 items in last 60d (40 returned) for “OK Hand Sign”",
    ...
    scoreReasons: {
      relevance: "Recent creation signals rose modestly. Signals: news/recent-articles=32 (Google News: 3 items in last 60d (40 returned) for “OK Hand Sign”)",
