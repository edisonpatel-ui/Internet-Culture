...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Recent creation signals rose modestly. Signals: news/recent-articles=44 (Google News: 6 items in last 60d (40 returned) for “Salt Bae”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Absurdity / cohort character cues still match the prior brainrot reading. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      "[wikipedia/search-interest] Wikipedia page “Salt Bae” found but pageviews unavailable",
      ...
      "[news/recent-articles] Google News: 6 items in last 60d (40 returned) for “Salt Bae”",
    ...
    scoreReasons: {
      relevance: "Recent creation signals rose modestly. Signals: news/recent-articles=44 (Google News: 6 items in last 60d (40 returned) for “Salt Bae”)",
