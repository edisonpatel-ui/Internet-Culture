...
const entry: MemeEntry = {
  ...
  scores: { relevance: 37, influence: 58, cringe: 21, brainrot: 32 },
  dynamicMetadata: {
    ...
    evidenceNotes: [
      ...
      "[dictionary/platform-activity] Wiktionary lookup unavailable for “Prime”",
      "[news/recent-articles] Google News: 12 items in last 30d (40 returned) for “Prime Hydration”",
