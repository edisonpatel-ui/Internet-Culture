...
const entry: MemeEntry = {
  ...
  scores: { relevance: 29, influence: 84, cringe: 21, brainrot: 26 },
  dynamicMetadata: {
    ...
    popularityNotes: "Status: classic · Relevance 29 (today's recognition, not influence) · Trending 31 (recent attention)",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 5 items in last 30d (40 returned) for “Two Buttons”",
