...
const entry: MemeEntry = {
  ...
  dynamicMetadata: {
    ...
    popularityNotes: "Relevance: Recent creation signals rose modestly. Signals: news/recent-articles=41 (Google News: 5 items in last 60d (40 returned) for “Corn Kid”) Influence: Permanent cultural impact is not changed by a dynamic refresh. Brainrot: Character signals still mark this as strongly representative of chaotic internet brainrot culture. Cringe: Not enough mockery / social-awkwardness signals to reassess cringe.",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 5 items in last 60d (40 returned) for “Corn Kid”",
    ...
    scoreReasons: {
      relevance: "Recent creation signals rose modestly. Signals: news/recent-articles=41 (Google News: 5 items in last 60d (40 returned) for “Corn Kid”)",
