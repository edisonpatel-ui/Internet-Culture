...
const entry: MemeEntry = {
  ...
  scores: { relevance: 37, influence: 70, cringe: 21, brainrot: 32 },
  dynamicMetadata: {
    ...
    trendingScore: 33,
    recentRevival: false,
    popularityNotes: "Status: occasionally-referenced · Relevance 37 (today's recognition, not influence) · Trending 33 (recent attention)",
    evidenceNotes: [
      ...
      "[news/recent-articles] Google News: 3 items in last 30d (40 returned) for “Stonks”",
      "[creator-pages/recent-uploads] No YouTube channel_id URLs on entry sources — creator RSS skipped",
      "[authority-sources/authority-documentation] Know Your Meme cited",
      "[google-trends/search-interest] Not on current Google US Trending RSS (10 topics) — not treated as zero search interest",
      "[google-trends/editorial-trend] Absence from daily trending list → not currently spiking",
      "[reddit/discussion-volume] Reddit search unavailable for “Stonks”",
