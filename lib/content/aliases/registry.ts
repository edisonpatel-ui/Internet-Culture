...
export const ALIAS_REGISTRY: AliasRegistry = {
  ...
  "dupe-economy": [
    ...
    "stanley tumbler trend",
  ],
  goat: ["g.o.a.t.", "goat meaning", "greatest of all time"],
  goated: ["goated meaning", "he's goated", "she's goated", "goated af"],
  "italian-brainrot": [
    "italian brainrot",
    "tralalero tralala",
  ...
  "first-meme": [
    ...
    "first internet meme",
    "oldest meme",
    "expectations vs reality cartoon",
    "1921 meme",
  ],
  "dancing-baby": ["dancing baby", "baby cha cha", "cha cha baby"],
  "dad-bod": ["dad bod", "dadbod", "dad body"],
  karen: ["karen meme", "karen slang", "calling someone karen"],
  "fast-fashion-boom": [
    "fast fashion",
    "shein haul",
    "temu haul",
  ...
  "barbiecore": ["barbie core", "barbie aesthetic", "pink barbie fashion"],
  "coquette-aesthetic": ["coquette", "coquette core", "coquette aesthetic"],
  stonks: ["stonks meme", "stonks guy", "investment stonks"],
  soyjak: ["soyjak", "soy jack", "soy face"],
  "virgin-vs-chad": ["virgin vs chad", "virgin chad", "yes chad"],
