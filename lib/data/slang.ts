...
export const slangTerms: SlangEntry[] = [
  ...
  },
  {
    ...
    definition:
      "Slang exclamation derived from 'god damn' — used to react to something impressive or surprising. Frequently memed.",
    origin:
      "Streamer and TikTok comment culture. Often associated with exaggerated reactions in live streams.",
    usageExamples: [
