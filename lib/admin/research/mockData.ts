...
export const MOCK_RESEARCH_SESSIONS: ResearchSession[] = [
  {
    ...
    activityLog: [
      ...
      },
      {
        ...
        actor: "editor",
        message: "Sources added",
      },
      {
        id: "act_1c",
        at: "2026-07-15T11:20:00.000Z",
        actor: "editor",
  ...
  },
  {
    ...
    internalLinks: [
      ...
      },
      {
        ...
        reason: "Adjacent Gen Alpha absurdist cluster",
      },
    ],
    confidence: [
      {
  ...
  {
    id: "rs_italian_brainrot",
    topic: "Italian Brainrot",
    status: "active",
    createdAt: "2026-07-08T09:00:00.000Z",
    updatedAt: "2026-07-17T12:00:00.000Z",
    notes:
      "Classify carefully — brainrot cluster vs single meme. Link RC4-C mock report.",
    tags: ["brainrot", "meme", "gen-alpha"],
    priority: "high",
    workflowStage: "ResearchRequested",
    sources: [
      {
        id: "src_ib1",
        title: "Know Your Meme (candidate)",
        category: "know_your_meme",
        notes: "Confirm page exists before citing",
      },
    ],
    timeline: [],
    entities: [],
    ...
    internalLinks: [
      {
        ...
        reason: "Adjacent Gen Alpha absurdist culture",
      },
    ],
    confidence: [],
    coverageNotes: ["May need brainrot category placement"],
    aiSuggestions: [],
    activityLog: [
      {
        id: "act_ib1",
  ...
  },
  {
    ...
    notes: "Separate format from NPC meme. Trend candidate.",
    tags: ["trend", "tiktok", "streaming"],
    priority: "medium",
    workflowStage: "ResearchRequested",
    sources: [],
    timeline: [],
    ...
    relationships: [
      {
        id: "rel_npc1",
        kind: "inspired_by",
        targetTitle: "NPC meme",
        reason: "Performance metaphor",
      },
    ],
    internalLinks: [
      {
        ...
        kind: "missing_article",
        label: "NPC Streaming",
        reason: "Gap candidate",
      },
    ],
    confidence: [],
    coverageNotes: ["No catalog entry yet"],
    aiSuggestions: [],
    activityLog: [
      {
        id: "act_npc1",
  ...
  },
  {
    ...
    notes: "Slang — careful framing around incel-adjacent discourse.",
    tags: ["slang", "sensitive"],
    priority: "medium",
    workflowStage: "ResearchRequested",
    sources: [],
    timeline: [],
    ...
    internalLinks: [],
    confidence: [],
    coverageNotes: ["Handle sensitively; no medical advice"],
    aiSuggestions: [],
    activityLog: [
      {
        id: "act_lm1",
  ...
  },
  {
    ...
    notes: "Event entry — date-bound theatrical crossover meme.",
    tags: ["event", "meme", "2023"],
    priority: "low",
    workflowStage: "ResearchComplete",
    recommendationResolutions: [],
    sources: [
      {
        id: "src_bh1",
        title: "Film release calendars / press",
        category: "journalism",
      },
    ],
    timeline: [
      {
        ...
        date: "2023-07-21",
        precision: "day",
        description: "Shared US release date",
        confidence: 0.95,
      },
    ],
    entities: [],
    ...
    coverageNotes: ["Strong press record"],
    aiSuggestions: [],
    activityLog: [
      {
        id: "act_bh1",
